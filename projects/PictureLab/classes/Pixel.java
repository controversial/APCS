...
public class Pixel
{
  ...
  /**
  * Method to get the distance between this pixel's color and the passed pixel
  * @param testColor the color to compare to
  * @return the distance between this pixel's color and the passed pixel
  */
 public double colorDistance(Pixel other) {
   return Math.sqrt(
     Math.pow(Math.abs(this.getRed() - other.getRed()), 2) +
     Math.pow(Math.abs(this.getGreen() - other.getGreen()), 2) +
     Math.pow(Math.abs(this.getBlue() - other.getBlue()), 2)
   );
 }
