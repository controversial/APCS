/**
 * The state of the robot includes the index of its location and the direction in which
 * it is facing (to the right or to the left). This information is specified in the
 * FuelRobot interface as shown in the following declaration.
 */
